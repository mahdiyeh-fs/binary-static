...
const BinaryLoader = (() => {
    ...
    const displayMessage = (localized_message) => {
        ...
        const div_container = createElement('div', { class: 'container logged_out_title_container', html: Client.isAccountOfType('financial') || Client.isOptionsBlocked() ? '' : content.getElementsByTagName('h1')[0] || '' });
