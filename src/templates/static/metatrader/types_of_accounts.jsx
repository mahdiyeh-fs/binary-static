                    ...
                    <Table
                        ...
                        data={{
                            ...
                            tbody: [
                                ...
                                [{ text: <Row             text={it.L('Trading instruments')} /> },    { text: it.L('FX-majors (standard), FX-minors, Commodities, Cryptocurrencies, Stocks, and Stock Indices.') }, { text: it.L('Synthetics') }],
                            ],
                        }}
                    />
                </div>
